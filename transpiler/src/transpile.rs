...
pub fn c_fixes_after_preprocessor(input: &str, output: &str) {
    let mut src = read_to_string(input).unwrap();
    src = replace_identifier(src, "memmove", "spine38_memmove", 0);
    src = replace_identifier(src, "strlen", "spine38_strlen", 0);
    src = replace_identifier(src, "memcpy", "spine38_memcpy", 0);
    src = replace_identifier(src, "memset", "spine38_memset", 0);
    ...
    src = replace_identifier(src, "sqrtf", "spine38_sqrtf", 0);
    ...
    src = replace_identifier(src, "malloc", "spine38_malloc", 0);
    src = replace_identifier(src, "realloc", "spine38_realloc", 0);
    src = replace_identifier(src, "free", "spine38_free", 0);
    ...
    src = replace_identifier(src, "rand", "spine38_rand", 0);
    src = replace_identifier(src, "fopen", "spine38_fopen", 0);
    src = replace_identifier(src, "fseek", "spine38_fseek", 0);
    src = replace_identifier(src, "ftell", "spine38_ftell", 0);
    src = replace_identifier(src, "fread", "spine38_fread", 0);
    src = replace_identifier(src, "fclose", "spine38_fclose", 0);
    src = replace_identifier(src, "fclose", "spine38_fclose", 0);
